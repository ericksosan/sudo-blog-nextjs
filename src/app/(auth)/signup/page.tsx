        ...
        <form>
          <div>
            <div className="flex gap-y-6 mb-6 flex-col lg:flex-row gap-x-4 w-full">
              <div className="w-full relative lg:w-1/2">
                <label className="flex  items-center mb-2 text-sm font-medium">First Name <svg width={7} height={7} className="ml-1" viewBox="0 0 7 7" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="w-full relative lg:w-1/2">
                <label className="flex  items-center mb-2 text-sm font-medium">Last Name <svg width={7} height={7} className="ml-1" viewBox="0 0 7 7" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M3.11222 6.04545L3.20668 3.94744L1.43679 5.08594L0.894886 4.14134L2.77415 3.18182L0.894886 2.2223L1.43679 1.2777L3.20668 2.41619L3.11222 0.318182H4.19105L4.09659 2.41619L5.86648 1.2777L6.40838 2.2223L4.52912 3.18182L6.40838 4.14134L5.86648 5.08594L4.09659 3.94744L4.19105 6.04545H3.11222Z" fill="#EF4444" />
                </svg>
                </label>
            ...
            <div className="relative mb-6">
              <label className="flex  items-center mb-2 text-sm font-medium">Email Address <svg width={7} height={7} className="ml-1" viewBox="0 0 7 7" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M3.11222 6.04545L3.20668 3.94744L1.43679 5.08594L0.894886 4.14134L2.77415 3.18182L0.894886 2.2223L1.43679 1.2777L3.20668 2.41619L3.11222 0.318182H4.19105L4.09659 2.41619L5.86648 1.2777L6.40838 2.2223L4.52912 3.18182L6.40838 4.14134L5.86648 5.08594L4.09659 3.94744L4.19105 6.04545H3.11222Z" fill="#EF4444" />
              </svg>
              </label>
              <input type="text" className="input input-bordered w-full" placeholder="goodluck@goodluck.com" required />
            </div>
            <div className="flex gap-y-6 mb-6 flex-col lg:flex-row lg:gap-x-6">
              ...
              <div className="w-full lg:w-1/2 relative">
                <label className="flex  items-center mb-2 text-sm font-medium">Confirm Password <svg width={7} height={7} className="ml-1" viewBox="0 0 7 7" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M3.11222 6.04545L3.20668 3.94744L1.43679 5.08594L0.894886 4.14134L2.77415 3.18182L0.894886 2.2223L1.43679 1.2777L3.20668 2.41619L3.11222 0.318182H4.19105L4.09659 2.41619L5.86648 1.2777L6.40838 2.2223L4.52912 3.18182L6.40838 4.14134L5.86648 5.08594L4.09659 3.94744L4.19105 6.04545H3.11222Z" fill="#EF4444" />
                </svg>
                </label>
                <input type="password" className="input input-bordered w-full" placeholder="Password" required />
          ...
          <div className="p-4 flex items-center justify-center">
            <span>Already have an account?{" "}
              <Link href="/signin" className="text-secondary font-medium group relative w-max">
                Sign in
